...
//     this.meta.per_page = page.pageSize;
//     this.meta.current_page = page.pageIndex + 1;
//       this.productService.list(this.store.id,null,'', this.meta.current_page,this.meta.per_page).subscribe({
//         next: (response) => {
//           this.assignData(response);
//         }
//       });
...
//   getBaseUnitName(product: Product): string {
//     const baseUnit = product.unit_of_measures?.find(unit => unit.is_base_unit);
//     return baseUnit ? baseUnit.name : 'unité';
//   }
